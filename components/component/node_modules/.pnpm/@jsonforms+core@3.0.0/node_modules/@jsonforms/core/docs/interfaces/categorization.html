...
<head>
	...
	<title>Categorization | JSON Forms Core</title>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The categorization element, which may have children elements.
							A child element may either be itself a Categorization or a Category, hence
						the categorization element can be used to represent recursive structures like trees.</p>
					</div>
				</div>
			</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>The child elements of this categorization which are either of type
							<a href="category.html">Category</a> or <a href="categorization.html">Categorization</a>.</p>
						</div>
					</div>
				</section>
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite">
					...
					<h3>type</h3>
					<div class="tsd-signature tsd-kind-icon">type<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"Categorization"</span></div>
					<aside class="tsd-sources">
				...
				<ul class="current">
					<li class="current tsd-kind-interface tsd-has-type-parameter">
						...
						<ul>
							...
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="categorization.html#options" class="tsd-kind-icon">options</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="categorization.html#rule" class="tsd-kind-icon">rule</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite">
								<a href="categorization.html#type" class="tsd-kind-icon">type</a>
							</li>
						</ul>
					</li>
				</ul>
