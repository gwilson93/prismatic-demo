...
<head>
	...
	<title>GroupLayout | JSON Forms Core</title>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>A group resembles a vertical layout, but additionally might have a label.
						This layout is useful when grouping different elements by a certain criteria.</p>
					</div>
				</div>
			</section>
				...
				<ul class="current">
					<li class="current tsd-kind-interface tsd-has-type-parameter">
						...
						<ul>
							...
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="grouplayout.html#options" class="tsd-kind-icon">options</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="grouplayout.html#rule" class="tsd-kind-icon">rule</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite">
								<a href="grouplayout.html#type" class="tsd-kind-icon">type</a>
							</li>
						</ul>
					</li>
				</ul>
