...
<head>
	...
	<title>HorizontalLayout | JSON Forms Core</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="horizontallayout.html">HorizontalLayout</a>
				</li>
			</ul>
			<h1>Interface HorizontalLayout</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>A layout which orders its children horizontally (i.e. from left to right).</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						...
						<ul class="tsd-hierarchy">
							<li>
								<span class="target">HorizontalLayout</span>
							</li>
						</ul>
					</li>
				</ul>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="horizontallayout.html#elements" class="tsd-kind-icon">elements</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="horizontallayout.html#options" class="tsd-kind-icon">options</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="horizontallayout.html#rule" class="tsd-kind-icon">rule</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite"><a href="horizontallayout.html#type" class="tsd-kind-icon">type</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					...
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>The child elements of this layout.</p>
						</div>
					</div>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					...
					<h3><span class="tsd-flag ts-flagOptional">Optional</span> rule</h3>
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite">
					...
					<h3>type</h3>
					<div class="tsd-signature tsd-kind-icon">type<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"HorizontalLayout"</span></div>
					<aside class="tsd-sources">
			...
			<nav class="tsd-navigation secondary menu-sticky">
				...
				<ul class="current">
					<li class="current tsd-kind-interface">
						<a href="horizontallayout.html" class="tsd-kind-icon">Horizontal<wbr>Layout</a>
						<ul>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="horizontallayout.html#elements" class="tsd-kind-icon">elements</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="horizontallayout.html#options" class="tsd-kind-icon">options</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="horizontallayout.html#rule" class="tsd-kind-icon">rule</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite">
								<a href="horizontallayout.html#type" class="tsd-kind-icon">type</a>
							</li>
						</ul>
					</li>
				</ul>
