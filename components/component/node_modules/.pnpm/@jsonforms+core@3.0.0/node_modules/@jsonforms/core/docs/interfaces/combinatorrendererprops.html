...
<head>
	...
	<title>CombinatorRendererProps | JSON Forms Core</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="combinatorrendererprops.html">CombinatorRendererProps</a>
				</li>
			</ul>
			<h1>Interface CombinatorRendererProps</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<a href="statepropsofcombinator.html" class="tsd-signature-type">StatePropsOfCombinator</a>
					</li>
					<li>
						<a href="dispatchpropsofcontrol.html" class="tsd-signature-type">DispatchPropsOfControl</a>
						<ul class="tsd-hierarchy">
							<li>
								<span class="target">CombinatorRendererProps</span>
							</li>
						</ul>
					</li>
				</ul>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section tsd-is-inherited">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-inherited"><a href="combinatorrendererprops.html#cells" class="tsd-kind-icon">cells</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="combinatorrendererprops.html#config" class="tsd-kind-icon">config</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-inherited"><a href="combinatorrendererprops.html#data" class="tsd-kind-icon">data</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="combinatorrendererprops.html#description" class="tsd-kind-icon">description</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="combinatorrendererprops.html#enabled" class="tsd-kind-icon">enabled</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="combinatorrendererprops.html#errors" class="tsd-kind-icon">errors</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-inherited"><a href="combinatorrendererprops.html#id" class="tsd-kind-icon">id</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="combinatorrendererprops.html#indexoffittingschema" class="tsd-kind-icon">index<wbr>OfFitting<wbr>Schema</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="combinatorrendererprops.html#label" class="tsd-kind-icon">label</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-inherited"><a href="combinatorrendererprops.html#path" class="tsd-kind-icon">path</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="combinatorrendererprops.html#renderers" class="tsd-kind-icon">renderers</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="combinatorrendererprops.html#required" class="tsd-kind-icon">required</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-inherited"><a href="combinatorrendererprops.html#rootschema" class="tsd-kind-icon">root<wbr>Schema</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="combinatorrendererprops.html#schema" class="tsd-kind-icon">schema</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-inherited"><a href="combinatorrendererprops.html#uischema" class="tsd-kind-icon">uischema</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="combinatorrendererprops.html#uischemas" class="tsd-kind-icon">uischemas</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="combinatorrendererprops.html#visible" class="tsd-kind-icon">visible</a></li>
							</ul>
						</section>
						<section class="tsd-index-section tsd-is-inherited">
							<h3>Methods</h3>
							<ul class="tsd-index-list">
								<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-inherited"><a href="combinatorrendererprops.html#handlechange" class="tsd-kind-icon">handle<wbr>Change</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group tsd-is-inherited">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-inherited">
					...
					<div class="tsd-signature tsd-kind-icon">cells<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>cell<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">; </span>tester<span class="tsd-signature-symbol">: </span><a href="../globals.html#rankedtester" class="tsd-signature-type">RankedTester</a><span class="tsd-signature-symbol"> }</span><span class="tsd-signature-symbol">[]</span></div>
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					<a name="indexoffittingschema" class="tsd-anchor"></a>
					<h3>index<wbr>OfFitting<wbr>Schema</h3>
			...
			<section class="tsd-panel-group tsd-member-group tsd-is-inherited">
				...
				<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-inherited">
					...
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-inherited">
						<li class="tsd-signature tsd-kind-icon">handle<wbr>Change<span class="tsd-signature-symbol">(</span>path<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, value<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<div class="tsd-comment tsd-typography">
								<div class="lead">
									<p>Update handler that emits a data change</p>
								</div>
							</div>
							...
							<ul class="tsd-parameters">
								<li>
									...
									<div class="tsd-comment tsd-typography">
										<p>the path to the data to be updated</p>
									</div>
								</li>
								<li>
									<h5>value: <span class="tsd-signature-type">any</span></h5>
									<div class="tsd-comment tsd-typography">
										<p>the new value that should be written to the given path</p>
									</div>
								</li>
							</ul>
			...
			<nav class="tsd-navigation secondary menu-sticky">
				...
				<ul class="current">
					<li class="current tsd-kind-interface">
						<a href="combinatorrendererprops.html" class="tsd-kind-icon">Combinator<wbr>Renderer<wbr>Props</a>
						<ul>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-inherited">
								<a href="combinatorrendererprops.html#cells" class="tsd-kind-icon">cells</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="combinatorrendererprops.html#config" class="tsd-kind-icon">config</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-inherited">
								<a href="combinatorrendererprops.html#data" class="tsd-kind-icon">data</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="combinatorrendererprops.html#description" class="tsd-kind-icon">description</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="combinatorrendererprops.html#enabled" class="tsd-kind-icon">enabled</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="combinatorrendererprops.html#errors" class="tsd-kind-icon">errors</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-inherited">
								<a href="combinatorrendererprops.html#id" class="tsd-kind-icon">id</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="combinatorrendererprops.html#indexoffittingschema" class="tsd-kind-icon">index<wbr>OfFitting<wbr>Schema</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="combinatorrendererprops.html#label" class="tsd-kind-icon">label</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-inherited">
								<a href="combinatorrendererprops.html#path" class="tsd-kind-icon">path</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="combinatorrendererprops.html#renderers" class="tsd-kind-icon">renderers</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="combinatorrendererprops.html#required" class="tsd-kind-icon">required</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-inherited">
								<a href="combinatorrendererprops.html#rootschema" class="tsd-kind-icon">root<wbr>Schema</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="combinatorrendererprops.html#schema" class="tsd-kind-icon">schema</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-inherited">
								<a href="combinatorrendererprops.html#uischema" class="tsd-kind-icon">uischema</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="combinatorrendererprops.html#uischemas" class="tsd-kind-icon">uischemas</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="combinatorrendererprops.html#visible" class="tsd-kind-icon">visible</a>
							</li>
							<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-inherited">
								<a href="combinatorrendererprops.html#handlechange" class="tsd-kind-icon">handle<wbr>Change</a>
							</li>
						</ul>
					</li>
				</ul>
