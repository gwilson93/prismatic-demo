...
<head>
	...
	<title>Layout | JSON Forms Core</title>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Represents a layout element which can order its children
						in a specific way.</p>
					</div>
				</div>
			</section>
					...
					<li>
						...
						<ul class="tsd-hierarchy">
							<li>
								...
								<ul class="tsd-hierarchy">
									<li>
										<a href="verticallayout.html" class="tsd-signature-type">VerticalLayout</a>
									</li>
									<li>
										<a href="horizontallayout.html" class="tsd-signature-type">HorizontalLayout</a>
									</li>
									<li>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="layout.html#elements" class="tsd-kind-icon">elements</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="layout.html#options" class="tsd-kind-icon">options</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="layout.html#rule" class="tsd-kind-icon">rule</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-inherited"><a href="layout.html#type" class="tsd-kind-icon">type</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
					...
					<div class="tsd-comment tsd-typography">
						<div class="lead">
							<p>The type of this UI schema element.</p>
						</div>
					</div>
				</section>
			</section>
					...
					<li class="current tsd-kind-interface">
						...
						<ul>
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="layout.html#elements" class="tsd-kind-icon">elements</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="layout.html#options" class="tsd-kind-icon">options</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="layout.html#rule" class="tsd-kind-icon">rule</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-inherited">
								<a href="layout.html#type" class="tsd-kind-icon">type</a>
							</li>
						</ul>
					</li>
				</ul>
