...
<head>
	...
	<title>JsonFormsCore | JSON Forms Core</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="jsonformscore.html">JsonFormsCore</a>
				</li>
			</ul>
			<h1>Interface JsonFormsCore</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">JsonFormsCore</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								...
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="jsonformscore.html#schema" class="tsd-kind-icon">schema</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="jsonformscore.html#uischema" class="tsd-kind-icon">uischema</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="jsonformscore.html#validationmode" class="tsd-kind-icon">validation<wbr>Mode</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="jsonformscore.html#validator" class="tsd-kind-icon">validator</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in packages/core/src/reducers/core.ts:64</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					<a name="errors" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagOptional">Optional</span> errors</h3>
					<div class="tsd-signature tsd-kind-icon">errors<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">ErrorObject</span><span class="tsd-signature-symbol">[]</span></div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in packages/core/src/reducers/core.ts:67</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in packages/core/src/reducers/core.ts:65</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in packages/core/src/reducers/core.ts:66</li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					<a name="validationmode" class="tsd-anchor"></a>
					<h3><span class="tsd-flag ts-flagOptional">Optional</span> validation<wbr>Mode</h3>
				...
				<ul class="current">
					<li class="current tsd-kind-interface">
						...
						<ul>
							...
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="jsonformscore.html#data" class="tsd-kind-icon">data</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="jsonformscore.html#errors" class="tsd-kind-icon">errors</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="jsonformscore.html#schema" class="tsd-kind-icon">schema</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="jsonformscore.html#uischema" class="tsd-kind-icon">uischema</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="jsonformscore.html#validationmode" class="tsd-kind-icon">validation<wbr>Mode</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="jsonformscore.html#validator" class="tsd-kind-icon">validator</a>
							</li>
						</ul>
					</li>
				</ul>
