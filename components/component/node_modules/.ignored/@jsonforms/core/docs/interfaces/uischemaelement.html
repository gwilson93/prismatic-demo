...
<head>
	...
	<title>UISchemaElement | JSON Forms Core</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="uischemaelement.html">UISchemaElement</a>
				</li>
			</ul>
			<h1>Interface UISchemaElement</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Common base interface for any UI schema element.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">UISchemaElement</span>
						<ul class="tsd-hierarchy">
							<li>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="uischemaelement.html#options" class="tsd-kind-icon">options</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="uischemaelement.html#rule" class="tsd-kind-icon">rule</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="uischemaelement.html#type" class="tsd-kind-icon">type</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<nav class="tsd-navigation secondary menu-sticky">
				...
				<ul class="current">
					<li class="current tsd-kind-interface">
						<a href="uischemaelement.html" class="tsd-kind-icon">UISchema<wbr>Element</a>
						<ul>
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="uischemaelement.html#options" class="tsd-kind-icon">options</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="uischemaelement.html#rule" class="tsd-kind-icon">rule</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="uischemaelement.html#type" class="tsd-kind-icon">type</a>
							</li>
						</ul>
					</li>
				</ul>
